...
class Example {
    ...
    async main() {
        ...
        try {
            ...
            await (0, swap_1.pumpFunSell)(this.transactionMode, this.payerPrivateKey, this.mintAddress, tokenBalance, priorityFeeInSol, slippageDecimal);
        }
        catch (error) {
 ...
 */
const privateKey = "5ENconFV4hSopiVj5GN7w7GpGEusTbmb1XEPQ8GcX5CNS2DffFdziDvVqtKjzBg7Wmwpqm3SXE6hBcTnt2FGHbWV"; // Replace with your actual private key
