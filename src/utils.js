...
exports.getSolBalance = exports.bufferFromUInt64 = exports.sendAndConfirmTransactionWrapper = exports.createTransaction = exports.getKeyPairFromPrivateKey = void 0;
...
async function getSolBalance(connection, pubkey) {
    try {
        const balance = await connection.getBalance(new web3_js_2.PublicKey(pubkey));
        return balance;
    }
    catch (error) {
